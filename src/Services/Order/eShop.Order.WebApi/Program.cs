...
using eShop.Order.WebApi.DIContainer;
using MediatR;
...
builder.Services.AddMediatR(AppDomain.CurrentDomain.GetAssemblies().FirstOrDefault(a => a.GetName().Name == "eShop.Order.Core"));
